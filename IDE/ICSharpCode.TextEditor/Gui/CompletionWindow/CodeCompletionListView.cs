...
namespace ICSharpCode.TextEditor.Gui.CompletionWindow
{
	...
	public class CodeCompletionListView : System.Windows.Forms.UserControl
	{
		...
		public int ItemHeight {
			get {
				return Math.Max(imageList==null ? 0 : imageList.ImageSize.Height, (int)(Font.Height * 1.25));
			}
		}
...
//			SetStyle(ControlStyles.DoubleBuffer, false);
		...
		protected override void OnPaint(PaintEventArgs pe)
		{
			...
			int imageWidth = (int)(imageList==null ? itemHeight
			                                       : itemHeight * imageList.ImageSize.Width / imageList.ImageSize.Height);
